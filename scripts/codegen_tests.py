...
TEST_DIR = r"/home/zerongl/src/sm83/v1"
CPP_HEADER_TEMPLATE = Template("""// AutoGenerated using codegent_tests.py
...
for test_file in pathlib.Path(TEST_DIR).glob("1*.json"):
