...
constexpr uint16_t REG_LCD_VIEW_SCROLL_X              = 0xFF42;
constexpr uint16_t REG_LCD_VIEW_SCROLL_Y              = 0xFF43;
constexpr uint16_t REG_LCD_VIEW_POS_X                 = 0xFF44;
constexpr uint16_t REG_LCD_VIEW_POS_Y                 = 0xFF45;
